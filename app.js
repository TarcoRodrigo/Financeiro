...
function rInicio(){
  ...
  var h='<div class="hero"><div class="hero-label">Patrimonio Total</div><div class="hero-valor'+(tot<0?' r':'')+'">'+fR(tot)+'</div><div class="hero-row"><div class="hero-pill"><div class="pl">Receitas</div><div class="pv g">'+fRs(rec)+'</div></div><div class="hero-pill"><div class="pl">Despesas</div><div class="pv r">'+fRs(dep)+'</div></div><div class="hero-pill"><div class="pl">Saldo</div><div class="pv '+(rec-dep>=0?'g':'r')+'">'+fRs(rec-dep)+'</div></div></div></div>';
